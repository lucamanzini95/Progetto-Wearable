              ...
              if(snapshot.hasData)
              {
                ...
                for(int i = 0; i < mySleepData.length; i++)
                {
                  switch (mySleepData[i].level) {
                    case 'deep':
                    {
                      mySpots.add(FlSpot(timeToDouble(mySleepData[i].entryDateTime), 0));
                    }
                    break;
                    case 'light':
                    {
                      mySpots.add(FlSpot(timeToDouble(mySleepData[i].entryDateTime), 1));
                    }
                    break;
                    case 'rem':
                    {
                      mySpots.add(FlSpot(timeToDouble(mySleepData[i].entryDateTime), 2));
                    }
                    break;
                    case 'wake':
                    {
                        mySpots.add(FlSpot(timeToDouble(mySleepData[i].entryDateTime), 3));
                      }
                    break;
                    default:
                    {
